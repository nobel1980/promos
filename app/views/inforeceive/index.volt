...
<div class="center scaffold">
   ...
   <div style="position: absolute; right: 215px; top: 93px; width: 350px;" class="highlight_div">
       <ul>
           ...
           <li><i class='flaticon-viewing'></i>&nbsp;প্রতিবেদন প্রদান করা হয়েছে, সঠিক তথ্য থাকলে গ্রহণ করুন নতুবা পুনরায় প্রদানের জন্য প্রেরণ করুন</li>
       </ul>
   </div>
...
i.flaticon-viewing, a i.flaticon-viewing
{
    color: green !important;
}
</style>
