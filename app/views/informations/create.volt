...
<div class="highlight_div" >
    ...
    <input type="hidden" name="division" id="division" value="<?php echo $userinfo['division']; ?>" />
    <input type="hidden" name="district" id="district" value="<?php echo $userinfo['district']; ?>" />
</div>
<hr />
<div class="tabbable">
